...
/**
 * @Title: SimpleHttpAsyncClientDemo.java
 * @Package com.fyj.utils.fetcher
 * @author 冯亚军
 * @date 2017年3月2日下午2:51:25
...
public class SimpleHttpAsyncClientDemo {
	...
	/**
	 * @Title: custom
	 * @Description: 设置信任自定义的证书
	 * @param keyStorePath
	 *            密钥库路径
	 * @param keyStorepass
	 *            密钥库密码
	 * @return
	 * @return SSLContext 返回类型
	 */
	 ...
	 * @param port
	 * @return
	 * @return HttpAsyncClientBuilder 返回类型
	 */
	 ...
	 * @return void 返回类型
	 */
	public static void send(String url, Map<String, String> map, final String encoding, final AsyncHandler handler)
	...
	static class AsyncHandler implements IHandler {
		...
		public Object failed(Exception e) {
			System.err.println(
					Thread.currentThread().getName() + "--失败了--" + e.getClass().getName() + "--" + e.getMessage());
			return null;
		}
